...
describe('item tests', function () {
  describe('title tests', function () {
    ...
    it('should throw error if more than 255 title chars for new item', function () {
      const createError = () => {
        return new Item('More then 255 a\'s: ')
      }
